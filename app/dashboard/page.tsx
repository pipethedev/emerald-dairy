import { AddIcon, EditIcon, ExpandMoreIcon, HeartsOutlineIcon, LeftAlignIcon, MobileHearts, MoreHorisIcon, SearchIcon, SettingsIcon, TagIcon } from '@/components/svgs';
          ...
          <div className='flex flex-col gap-[24px]'>
            {
              notesPreviewData.map((note, i) => (
                <div key={i} className='bg-[#FAFAFA] w-full p-[16px] rounded-[12px]'>
                  ...
                  <div className='flex gap-[8px]'>
                    <div className='h-[28px] px-[8px] rounded-[8px] bg-[#F2F2F2] flex gap-[8px] items-center'>
                      <EditIcon />
                      <p className='text-[#808080] text-[10px] font-medium'>{note.date}</p>
                    </div>
                    {
                      note.favorite && (
                    ...
                    <div className='h-[28px] px-[8px] rounded-[8px] bg-[#F2F2F2] flex gap-[8px] items-center'>
                      <TagIcon />
                      <p className='text-[#808080] text-[10px] font-medium'>{note.tag}</p>
                    </div>
                  </div>
                </div>
              ))
